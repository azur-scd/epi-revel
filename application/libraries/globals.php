...
function ancestor_header_image($ancestor)
{
    $ancestor_theme = get_db()->getTable('CollectionTheme')->find($ancestor);
    $headerImage = $ancestor_theme['theme_options'];
    $array = explode('"', $headerImage);
