...
<div id="primary">
    ...
    <div>
        <?php if (buttonPdf($item) != null) : ?>
            <a href="<?php echo buttonPdf($item); ?>" class="btn btn-secondary btn-sm" style='background-color:<?php echo $themeColor ?>;'>Lire ce document</a>
        <?php endif; ?>

        <!-- bouton pour cycnos -->
        <?php if (buttonCycnos($item) != null) : ?>
            <a href="<?php echo buttonCycnos($item); ?>" class="btn btn-secondary btn-sm" style='background-color:<?php echo $themeColor ?>;'>Lire ce document</a>
        <?php endif; ?>

        <?php if (buttonVideo($item) != null) : ?>
            <a href="<?php echo buttonVideo($item); ?>" class="btn btn-secondary btn-sm" style='background-color:<?php echo $themeColor ?>;'>Voir cette vidéo</a>
        <?php endif; ?>
            
        <?php if (buttonSource($item) != null) : ?>
            <a href="<?php echo buttonSource($item); ?>" class="btn btn-secondary btn-sm" style='background-color:<?php echo $themeColor ?>;'>Page de l'archive</a>
        <?php endif; ?>
    </div>
