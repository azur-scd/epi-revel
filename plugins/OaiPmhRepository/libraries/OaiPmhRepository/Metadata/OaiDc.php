...
class OaiPmhRepository_Metadata_OaiDc implements OaiPmhRepository_Metadata_FormatInterface
{
    ...
    {
        if(get_record_by_id('collection', metadata($item, 'Collection Id'))){
            set_current_record('collection', get_record_by_id('collection', metadata($item, 'Collection Id')));
        }
        else{
            set_current_record('collection', get_record_by_id('collection', 22));
        }
